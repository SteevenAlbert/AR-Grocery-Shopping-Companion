...
class _ProductsListState extends State<ProductsList> {
  ...
  void initState() {
    ...
    productDataSource = ProductDataSource(productData: products, context: context);
  }

  @override
  Widget build(BuildContext context) {
    return ElementsDataGrid(dataSource: productDataSource, columnNames: ['name', 'manufacturer', 'category']);
  }
}

class ProductDataSource extends DataGridSource {
  ProductDataSource({required List<Product> productData, required  this.context}) {
